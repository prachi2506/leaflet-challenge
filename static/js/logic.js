...
d3.json(queryURL).then(function(data){
    // wait for json response to proceed with creating feature sets
...
function createMap(earthquakes) {
   // Create tiles 
   let outdoorsLayer = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}", {
  ...
  let grayScaleLayer = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}", {
    attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
    maxZoom: 20,
    id: "light-v10",
    accessToken: API_KEY
  ...
  // Create our map, with grayscale layer and earthquakes 
  let myMap = L.map("map", {
    center: [
      37.09, -95.71
    ],
